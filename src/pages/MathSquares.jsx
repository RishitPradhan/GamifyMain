...
export default function MathSquares() {
  ...
  return (
    <div className="squares-page" style={{ fontFamily: 'monospace', minHeight: '100vh', width:'100%', margin:0, overflowX:'hidden', position:'relative', background: 'transparent' }}>
      <style>{`
        html, body, #root {
          width: 100% !important;
          margin: 0 !important;
        ...
        /* Larger, clearer typography specific to Squares page */
        .squares-page { font-size: 18px; line-height: 1.6; }
        .squares-page h1 { font-size: 2.1rem; }
        .squares-page h2 { font-size: 1.6rem; }
        .squares-page h3 { font-size: 1.25rem; }
        .squares-page li { font-size: 1.05rem; }
        .squares-page .btn { font-size: 1.05rem; }
        .squares-page input,
        .squares-page select,
        .squares-page textarea,
        .squares-page button { font-size: 1.05rem; }
      `}</style>
      {/* Content - full width */}
      <div style={{ position:'relative', zIndex:1, width:'100%', padding: '0 12px', boxSizing:'border-box', overflowX:'hidden', color: THEME.ink }}>
        ...
        <div style={{
          ...
          <h3 style={{
            color: '#7c3aed',
            fontSize: '1.2rem',
            textShadow: '0 0 10px rgba(124, 58, 237, 0.8), 2px 2px 0px #3a1764',
            marginBottom: '20px',
            letterSpacing: '2px',
            textAlign: 'center',
          ...
          <div style={{
            ...
            <video
              ...
              poster="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 800 450'%3E%3Crect width='800' height='450' fill='%237c3aed'/%3E%3Ctext x='400' y='225' text-anchor='middle' fill='white' font-family='monospace' font-size='24'%3E🎬 Maths Demo%3C/text%3E%3C/svg%3E"
            >
          ...
          <p style={{
            ...
            📚 Watch this demo to understand squares and square roots before starting the activities!
          </p>
        </div>
